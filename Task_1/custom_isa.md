...
Instruction Encoding: (The order is not as i planned it to be. I had to add jump, move_init and add_imm during implementation once I realised i needed them and did not want to rewrite the bytecode etc.)
...
add_imm: opcode: 0x07, register: target register, data: direct value
